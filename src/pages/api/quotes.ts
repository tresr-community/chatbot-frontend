...
export const GET: APIRoute = async ({ request }) => {
  ...
  const quoteType = url.searchParams.get("type") || "quote";

  const quotesArray = quoteType === "crypto" ? QUOTES_CRYPTO : QUOTES_OUTAGE;
