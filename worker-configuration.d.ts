/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3825c97e4498c8e8aa4b63bbe8f8a0ff)
// Runtime types generated with workerd@1.20260312.1 2024-12-01 nodejs_compat_v2
declare namespace Cloudflare {
	interface DevelopmentEnv {
		R2_ASSETS: R2Bucket;
		ASSETS: Fetcher;
		DEBUG: true;
		TITLE: "TRESR Community ChatBot (Development)";
		FOOTER_MESSAGE: "*** DEVELOPMENT ENVIRONMENT ***";
		WELCOME_MESSAGE: "Hi, I'm Ron Jay.";
		AI_VERSION: "v1";
		AI_BACKEND: "chatbot";
		ALLOWED_ORIGINS: "{ \"allowed_origins\": [\"https://localhost\", \"https://localhost:9000\", \"https://localhost:9100\"] }";
		AI_SECRET: string;
	}
	interface PreviewEnv {
		...
		ASSETS: Fetcher;
		DEBUG: true;
		TITLE: "TRESR Community ChatBot (Preview)";
		FOOTER_MESSAGE: "*** PREVIEW ENVIRONMENT ***";
		WELCOME_MESSAGE: "Hi, I'm Ron Jay.";
		AI_VERSION: "v1";
		AI_BACKEND: "grok";
		ALLOWED_ORIGINS: "{ \"allowed_origins\": [\"https://preview.tresr.community\",\"https://preview.chat.tresr.community\"] }";
		AI_SECRET: string;
		CHATBOT_BACKEND: Fetcher /* tresr-community-chatbot-backend-preview */;
	}
	interface ProductionEnv {
		R2_ASSETS: R2Bucket;
		ASSETS: Fetcher;
		DEBUG: false;
		TITLE: "TRESR Community ChatBot";
		FOOTER_MESSAGE: "Ron Jay, serving the TRESR community since 2024.";
		WELCOME_MESSAGE: "Hi, I'm Ron Jay.";
		AI_BACKEND: "grok";
		AI_VERSION: "v1";
		ALLOWED_ORIGINS: "{ \"allowed_origins\": [\"https://tresr.community\",\"https://chat.tresr.community\"] }";
		AI_SECRET: string;
		CHATBOT_BACKEND: Fetcher /* tresr-community-chatbot-backend-production */;
	}
	interface Env {
		R2_ASSETS?: R2Bucket;
		ASSETS: Fetcher;
		DEBUG?: true | false;
		TITLE?: "TRESR Community ChatBot (Development)" | "TRESR Community ChatBot (Preview)" | "TRESR Community ChatBot";
		FOOTER_MESSAGE?: "*** DEVELOPMENT ENVIRONMENT ***" | "*** PREVIEW ENVIRONMENT ***" | "Ron Jay, serving the TRESR community since 2024.";
		WELCOME_MESSAGE?: "Hi, I'm Ron Jay.";
		AI_VERSION?: "v1";
		AI_BACKEND?: "chatbot" | "grok";
		ALLOWED_ORIGINS?: "{ \"allowed_origins\": [\"https://localhost\", \"https://localhost:9000\", \"https://localhost:9100\"] }" | "{ \"allowed_origins\": [\"https://preview.tresr.community\",\"https://preview.chat.tresr.community\"] }" | "{ \"allowed_origins\": [\"https://tresr.community\",\"https://chat.tresr.community\"] }";
		AI_SECRET: string;
		CHATBOT_BACKEND?: Fetcher /* tresr-community-chatbot-backend-preview */ | Fetcher /* tresr-community-chatbot-backend-production */;
	}
}
