...
declare namespace Cloudflare {
  ...
  interface Env {
    ...
    DEBUG?: true | false;
    TITLE?:
      | "TRESR Community ChatBot (Development)"
      | "TRESR Community ChatBot (Preview)"
      | "TRESR Community ChatBot";
    FOOTER_MESSAGE?:
      | "*** DEVELOPMENT ENVIRONMENT ***"
      | "*** PREVIEW ENVIRONMENT ***"
      | "Ron Jay, serving the TRESR community since 2024.";
    WELCOME_MESSAGE?: "Hi, I'm Ron Jay.";
    AI_VERSION?: "v1";
    AI_BACKEND?: "chatbot" | "grok";
    ALLOWED_ORIGINS?:
      | '{ "allowed_origins": ["https://localhost", "https://localhost:9000", "https://localhost:9100"] }'
      | '{ "allowed_origins": ["https://preview.tresr.community","https://preview.chat.tresr.community"] }'
      | '{ "allowed_origins": ["https://tresr.community","https://chat.tresr.community"] }';
    AI_SECRET: string;
    CHATBOT_BACKEND?:
      | Fetcher /* tresr-community-chatbot-backend-preview */
      | Fetcher /* tresr-community-chatbot-backend-production */;
  }
}
